    ...
    <div className="min-h-dvh bg-slate-950 text-white">
      <header className="px-6 pt-14 pb-8 max-w-3xl mx-auto">
        ...
        <div className="mt-4 flex gap-4 text-sm">
          ...
          <a href="https://basescan.org/address/0x5ec3a2a7a273e8fb43fa9840c1382b7287c5f532" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white">Contract on Basescan →</a>
        </div>
      </header>
            ...
            {[
              {
                ...
                address: '0x5ec3a2a7a273e8fb43fa9840c1382b7287c5f532',
              ...
              },
              {
                ...
                address: '0xcff66ad14754f31c1e7c43696be85d6ecca912ff',
